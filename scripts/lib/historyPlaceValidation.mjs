/** Mirror of supabase/functions/_shared/historyAroundTown/validation.ts */

export function countWords(text) {
  return text.trim().split(/\s+/).filter(Boolean).length;
}

export function isApprovedHistoryPlace(row) {
...
export function computeHistoryPlaceValidationStatus(row) {
