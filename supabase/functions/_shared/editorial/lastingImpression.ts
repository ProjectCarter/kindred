/**
 * Phase 7 — Lasting Impression Engine
 * End articles with memorable observations — never summaries or promotion.
 * Keep in sync with lib/edition/lastingImpression.ts
 */
...
/** Promotional or call-to-action endings — never publish. */
...
/** Timeless editor-style closings — observation, not promotion. */
