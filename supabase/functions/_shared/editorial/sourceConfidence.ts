/**
 * Phase 8 — Editorial Fact & Source Confidence Engine
 * Prevents uncertain information from being presented as fact.
 * Keep in sync with lib/edition/sourceConfidence.ts
 */
...
/** Hedging language — appropriate for inferred facts only. */
...
/** Attendance, crowd, or popularity stated as fact — reject unless verified. */
...
/** Wait times or lines stated without listing support. */
...
/** Unsupported local popularity claims. */
...
/** Unsupported superlatives without verification. */
...
/** Sensory or atmospheric facts presented as certainty. */
...
/** Historical or date claims stated confidently without grounding. */
