/**
 * Service / professional-business exclusion — Activities discovery only (server).
 *
 * Server source of truth mirrored on the client at
 * `lib/edition/serviceBusinessFilter.ts` (keep both in sync). Kindred's
 ...
 * services before they can enter the activities catalog or an Activities section.
 *
