...
function sampleArtwork(overrides: Partial<HeroArtworkRecord>): HeroArtworkRecord {
  return {
    ...
    museumName: overrides.museumName ?? null,
    museumLocation: overrides.museumLocation ?? null,
    officialMuseumUrl: overrides.officialMuseumUrl ?? null,
    officialArtworkUrl: overrides.officialArtworkUrl ?? null,
    sourceReferences: overrides.sourceReferences ?? [],
    detailEditorialStatus: overrides.detailEditorialStatus ?? "pending",
