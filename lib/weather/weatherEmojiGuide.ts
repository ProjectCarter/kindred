/**
 * Kindred Weather Emoji Guide — single source of truth for weather icons.
 * Every weather emoji in the app must come from this module.
 */
...
/** Canonical condition labels + emojis — do not duplicate elsewhere. */
...
/** Supplementary emojis for alerts and special guidance — not WMO conditions. */
...
/** Compact alert line for homepage — e.g. "🔥 Extreme Heat Warning". */
